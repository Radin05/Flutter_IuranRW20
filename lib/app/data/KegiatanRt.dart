class KegiatanRtResponse {
  String? message;
  List<KegiatanRt>? kegiatan;

  KegiatanRtResponse({this.message, this.kegiatan});

  KegiatanRtResponse.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    if (json['kegiatan'] != null) {
      kegiatan = <KegiatanRt>[];
      json['kegiatan'].forEach((v) {
        kegiatan!.add(new KegiatanRt.fromJson(v));
      });
    }
  }
...
class KegiatanRt {
  ...
  KegiatanRt.fromJson(Map<String, dynamic> json) {
    id = json['id'];
